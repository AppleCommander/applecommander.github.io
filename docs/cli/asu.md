`asu` is the AppleCommander AppleSingle tool. It is embedded within the AppleCommander application as well as both of the command-line tools. However, the dedicated tool has more control over its capabilities. The downloads can be found at the [asu](https://github.com/AppleCommander/asu) project.
